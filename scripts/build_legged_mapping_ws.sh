...
catkin build ocs2_legged_robot_ros rtabmap_ros legged_controllers legged_unitree_description legged_unitree_description legged_gazebo legged_navigation legged_elevation_mapping yujin_yrl_package am_navigation legged_unitree_hw legged_high_level_controller teb_local_planner legged_ros livox_ros_driver fast_lio livox_to_pointcloud2
